...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('stud_num')); ?>:</b>
	<?php echo CHtml::encode($data->stud_num); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('dept_insti')); ?>:</b>
	<?php echo CHtml::encode($data->dept_insti); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('was_curr_rel_to_job')); ?>:</b>
	<?php echo CHtml::encode($data->was_curr_rel_to_job); ?>
	<br />
