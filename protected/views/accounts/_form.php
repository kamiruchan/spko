...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'was_curr_rel_to_course'); ?>
		<?php echo $form->textField($model,'was_curr_rel_to_course',array('size'=>60,'maxlength'=>255)); ?>
		<?php echo $form->error($model,'was_curr_rel_to_course'); ?>
	</div>
