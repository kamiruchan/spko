...
class Roles extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('rolesID, rolesName', 'required'),
			array('rolesID', 'numerical', 'integerOnly'=>true),
			array('rolesName', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('rolesID, rolesName', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'users' => array(self::HAS_MANY, 'User', 'rolesID'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('rolesName',$this->rolesName,true);
